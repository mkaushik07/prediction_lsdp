...
function geoFail() {
    ...
    $("body").prepend('<div class="location-search"><h1>Rainfall Prediction Weather Finder</h1><span><input type="text" name="input-field" autofocus placeholder=" 500049 or Hyderabad,Miyapur"><button type="button" name="search"><i class="fa fa-search" aria-hidden="true"></i> Search</button></span></div>');
